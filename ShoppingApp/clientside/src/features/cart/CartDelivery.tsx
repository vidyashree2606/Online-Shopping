...
import { currency } from "../../app/utility/utility";
                ...
                <Table>
                    <TableBody>
                        ...
                        <TableRow>
                            ...
                            <TableCell align="right">{currency(deliveryFee)}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell colSpan={2}>Total</TableCell>
                            <TableCell align="right">{currency(subtotal + deliveryFee)}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell>
